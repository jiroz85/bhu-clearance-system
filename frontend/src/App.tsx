...
function App() {
  ...
  const loadAdmin = useCallback(async () => {
    ...
    try {
      ...
      const mappedSummary = {
        total: summaryData.totalClearances || 0,
        fullyCleared: summaryData.fullyCleared || 0,
        pausedRejected: summaryData.pausedRejected || 0,
        inProgress: summaryData.inProgress || 0,
      };

      setAdminSummary(mappedSummary);
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-xl border border-slate-200 px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                        value={loginPassword}
