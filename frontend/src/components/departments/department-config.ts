...
export const DEPARTMENT_CONFIGS: Record<DepartmentCode, DepartmentConfig> = {
  DEPT_HEAD: {
    ...
    icon: "Building",
    description:
      "Academic department clearance - verifies student academic standing",
    requirements: [
      {
        id: "academic_standing",
        label: "Student in good academic standing",
        type: "checkbox",
        required: true,
      },
      {
        id: "thesis_submitted",
        label: "Thesis/Project submitted (if applicable)",
        type: "checkbox",
        required: false,
      },
      {
        id: "advisor_approval",
        label: "Advisor approval obtained",
        type: "checkbox",
        required: true,
      },
      {
        id: "no_disciplinary_issues",
        label: "No pending disciplinary actions",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  LIBRARY: {
    ...
    requirements: [
      {
        id: "books_returned",
        label: "All borrowed books returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "fines_paid",
        label: "Library fines paid",
        type: "checkbox",
        required: true,
      },
      {
        id: "lost_books_cleared",
        label: "Lost book claims resolved",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  BOOKSTORE: {
    ...
    requirements: [
      {
        id: "textbooks_returned",
        label: "Unopened textbooks returned",
        type: "checkbox",
        required: false,
      },
      {
        id: "lab_materials_cleared",
        label: "Lab materials/equipment returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "outstanding_payments",
        label: "No outstanding material payments",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  DORMITORY: {
    ...
    requirements: [
      {
        id: "room_key_returned",
        label: "Room key returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "room_condition_ok",
        label: "Room condition acceptable",
        type: "checkbox",
        required: true,
      },
      {
        id: "damages_paid",
        label: "Damage fees paid (if applicable)",
        type: "checkbox",
        required: true,
      },
      {
        id: "personal_items_removed",
        label: "All personal items removed",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  CAFETERIA: {
    ...
    requirements: [
      ...
      {
        id: "meal_bills_paid",
        label: "Outstanding meal bills paid",
        type: "checkbox",
        required: true,
      },
      {
        id: "meal_plan_cancelled",
        label: "Meal plan properly cancelled",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  SPORTS: {
    ...
    requirements: [
      {
        id: "sports_uniform_returned",
        label: "Sports uniform returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "equipment_returned",
        label: "All borrowed equipment returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "team_clearance",
        label: "Team/athletics clearance (if applicable)",
        type: "checkbox",
        required: false,
      },
      {
        id: "facility_fees_paid",
        label: "Sports facility fees paid",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  POLICE: {
    ...
    requirements: [
      {
        id: "id_card_returned",
        label: "Student ID card returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "parking_permit_returned",
        label: "Parking permit returned (if applicable)",
        type: "checkbox",
        required: false,
      },
      {
        id: "no_security_incidents",
        label: "No unresolved security incidents",
        type: "checkbox",
        required: true,
      },
      {
        id: "no_outstanding_violations",
  ...
  DEAN: {
    ...
    requirements: [
      {
        id: "conduct_clear",
        label: "Student conduct record clear",
        type: "checkbox",
        required: true,
      },
      {
        id: "disciplinary_resolved",
        label: "All disciplinary matters resolved",
        type: "checkbox",
        required: true,
      },
      {
        id: "grievances_cleared",
        label: "Student grievances cleared",
        type: "checkbox",
        required: true,
      },
      {
        id: "exit_interview",
        label: "Exit interview completed (if required)",
        type: "checkbox",
        required: false,
      },
    ],
  ...
  ELEARNING: {
    ...
    requirements: [
      {
        id: "platform_access_revoked",
        label: "LMS/platform access properly handled",
        type: "checkbox",
        required: true,
      },
      {
        id: "digital_materials_returned",
        label: "Digital materials/licenses returned",
        type: "checkbox",
        required: true,
      },
      {
        id: "online_submissions_complete",
        label: "All online submissions complete",
        type: "checkbox",
        required: true,
      },
      {
        id: "tech_fees_paid",
        label: "Technology fees paid",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  CEP: {
    ...
    canCollectPayment: false,
    approvalWorkflow: "standard",
    trackingFields: ["serviceHours", "feedbackRating"],
  },
  ...
  FINANCE: {
    ...
    requirements: [
      {
        id: "tuition_paid",
        label: "Full tuition paid",
        type: "checkbox",
        required: true,
      },
      {
        id: "other_fees_paid",
        label: "All other university fees paid",
        type: "checkbox",
        required: true,
      },
      {
        id: "no_outstanding_balance",
      ...
      {
        id: "refund_processed",
        label: "Refund processed (if applicable)",
        type: "checkbox",
        required: false,
      },
    ],
  ...
  COST_SHARING: {
    ...
    requirements: [
      {
        id: "cost_share_agreement",
        label: "Cost-sharing agreement fulfilled",
        type: "checkbox",
        required: true,
      },
      {
        id: "service_obligation_met",
        label: "Service obligation completed (if applicable)",
        type: "checkbox",
        required: false,
      },
      {
        id: "documentation_complete",
        label: "All cost-share documentation complete",
        type: "checkbox",
        required: true,
      },
    ],
  ...
  REGISTRAR: {
    ...
    requirements: [
      {
        id: "academic_record_complete",
        label: "Academic record complete",
        type: "checkbox",
        required: true,
      },
      {
        id: "transcript_hold_cleared",
        label: "Transcript hold cleared",
        type: "checkbox",
        required: true,
      },
      {
        id: "degree_audit_complete",
        label: "Degree audit completed",
        type: "checkbox",
        required: true,
      },
      {
        id: "graduation_eligible",
        label: "Eligible for graduation/withdrawal",
        type: "checkbox",
        required: true,
      },
    ],
...
export function getDepartmentConfig(
  ...
  return Object.values(DEPARTMENT_CONFIGS).find(
    (d) => d.stepOrder === stepOrder,
  );
}

export function getDepartmentConfigByCode(
  code: DepartmentCode,
): DepartmentConfig {
...
export function getDepartmentCodeFromName(
  name: string,
...
export const DEPARTMENT_UI_COMPONENTS: Record<
  DepartmentCode,
