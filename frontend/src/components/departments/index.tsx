/**
 * Department-specific dashboard implementations
 * Each department wraps the BaseDepartmentDashboard with its specific config
 */
...
import {
  ...
  getDepartmentConfigByCode,
} from "./department-config";

// Re-export types for convenience
export type { BaseDepartmentDashboardProps, DepartmentReviewPayload };
export { DEPARTMENT_CONFIGS, getDepartmentConfigByCode };
...
// ============================================================================
// DASHBOARD REGISTRY - Map department codes to components
// ============================================================================

export const DEPARTMENT_DASHBOARDS = {
  DEPT_HEAD: DepartmentHeadDashboard,
  LIBRARY: LibraryDashboard,
  BOOKSTORE: BookstoreDashboard,
  DORMITORY: DormitoryDashboard,
  CAFETERIA: CafeteriaDashboard,
  SPORTS: SportsOfficeDashboard,
  POLICE: UniversityPoliceDashboard,
  DEAN: StudentDeanDashboard,
  ELEARNING: ELearningDashboard,
  CEP: CEPDashboard,
  FINANCE: FinanceDashboard,
  COST_SHARING: CostSharingDashboard,
  REGISTRAR: CollegeRegistrarDashboard,
} as const;

export type DepartmentDashboardComponent =
  (typeof DEPARTMENT_DASHBOARDS)[keyof typeof DEPARTMENT_DASHBOARDS];
